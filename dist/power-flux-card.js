...
const lang_de = {
  editor: {
    ...
    "powerwin_soc_span": "Tageshub",
    "powerwin_charged": "geladen",
    "powerwin_discharged": "entladen",
    "powerwin_roundtrip": "zurückgegeben",
    "powerwin_t_charge": "Zeit ladend",
    "powerwin_t_dis": "Zeit entladend",
    "powerwin_house_share": "Anteil am Hausbedarf",
    "powerwin_store_note": "Zusammen geladen",
    "powerwin_store_note2": "zusammen abgegeben",
    "powerwin_store_note3": "das deckte",
    "powerwin_store_note4": "des Hausbedarfs",
    "powerwin_src_pv": "PV direkt",
    "powerwin_src_grid": "Netz",
    "powerwin_use_house": "Haus direkt",
    "powerwin_use_export": "eingespeist",
    "powerwin_bal_src": "Woher der Strom kam",
    "powerwin_bal_need": "Hausbedarf",
    "powerwin_bal_use": "Wohin die Erzeugung ging",
    "powerwin_autarky": "Autarkie",
    "powerwin_selfq": "Eigenverbrauchsquote",
    "powerwin_gen": "Erzeugung",
    "powerwin_peak": "Spitze",
    "powerwin_5min": "5 Minuten",
    "powerwin_sys_data": "Datenlage",
    "powerwin_sys_res": "Auflösung",
    "powerwin_sys_buckets": "Messpunkte je Reihe",
    "powerwin_sys_feeds": "Reihen geliefert",
    "powerwin_sys_thin": "Reihen mit Lücken",
    "powerwin_sys_checks": "Prüfungen",
    "powerwin_sys_bal": "Bilanzabweichung Ø",
    "powerwin_sys_balmax": "größte Abweichung",
    "powerwin_sys_worst": "größter ungemessener Rest",
    "powerwin_sys_restday": "Rest über den Tag",
    "powerwin_sys_problems": "Reihen, die auffallen",
    "powerwin_sys_nodata": "keine Daten",
    "powerwin_sys_hint": "Eine Bilanzabweichung ist kein Fehler der Karte, sondern ein Hinweis, dass irgendwo ein Zähler an einem Pfad vorbeimisst.",
...
const lang_en = {
  editor: {
    ...
    "powerwin_soc_span": "Day swing",
    "powerwin_charged": "charged",
    "powerwin_discharged": "discharged",
    "powerwin_roundtrip": "returned",
    "powerwin_t_charge": "Time charging",
    "powerwin_t_dis": "Time discharging",
    "powerwin_house_share": "Share of house demand",
    "powerwin_store_note": "Charged together",
    "powerwin_store_note2": "delivered together",
    "powerwin_store_note3": "which covered",
    "powerwin_store_note4": "of house demand",
    "powerwin_src_pv": "PV direct",
    "powerwin_src_grid": "Grid",
    "powerwin_use_house": "House direct",
    "powerwin_use_export": "exported",
    "powerwin_bal_src": "Where the power came from",
    "powerwin_bal_need": "house demand",
    "powerwin_bal_use": "Where generation went",
    "powerwin_autarky": "Self-sufficiency",
    "powerwin_selfq": "Self-consumption rate",
    "powerwin_gen": "Generation",
    "powerwin_peak": "Peak",
    "powerwin_5min": "5 minutes",
    "powerwin_sys_data": "Data",
    "powerwin_sys_res": "Resolution",
    "powerwin_sys_buckets": "Points per series",
    "powerwin_sys_feeds": "Series delivered",
    "powerwin_sys_thin": "Series with gaps",
    "powerwin_sys_checks": "Checks",
    "powerwin_sys_bal": "Balance residual, mean",
    "powerwin_sys_balmax": "largest residual",
    "powerwin_sys_worst": "largest unmetered rest",
    "powerwin_sys_restday": "Rest over the day",
    "powerwin_sys_problems": "Series worth a look",
    "powerwin_sys_nodata": "no data",
    "powerwin_sys_hint": "A balance residual is not a fault of the card. It says a meter somewhere is measuring past a path.",
    "powerwin_storage_head": "Storage charged · share of generation",
